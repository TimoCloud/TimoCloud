...
public class ServerObjectCoreImplementation extends ServerObjectBasicImplementation implements ServerObject {
    ...
    public ServerObjectCoreImplementation(String name, String id, ServerGroupObject group, String state, String extra, String map, String motd, List<PlayerObject> onlinePlayers, int onlinePlayerCount, int maxPlayerCount, BaseObject base, InetSocketAddress socketAddress) {
