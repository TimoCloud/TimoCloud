...
public class PluginLoader {
    ...
    public void loadPlugins() {
        ...
        Map<TimoCloudPluginDescription, Boolean> used = new HashMap<>();
    ...
    public void load(TimoCloudPluginDescription plugin, List<TimoCloudPluginDescription> order, Map<TimoCloudPluginDescription, Boolean> used, int index) throws PluginLoadException {
        if (used.containsKey(plugin)) return;
        used.put(plugin, true);
        for (String depend : plugin.getDepends()) {
            ...
            if (used.containsKey(dependPlugin)) {
