...
public class LobbyCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        ServerInfo serverInfo = ProxyServer.getInstance().getServerInfo(TimoCloudBungee.getInstance().getLobbyManager().searchFreeLobby(player.getUniqueId(), player.getServer().getInfo().getName()).getName());
        if (serverInfo == null) {
