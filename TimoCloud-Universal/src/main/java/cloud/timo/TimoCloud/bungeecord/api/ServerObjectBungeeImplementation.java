...
public class ServerObjectBungeeImplementation extends ServerObjectBasicImplementation implements ServerObject {
    ...
    public ServerObjectBungeeImplementation(String name, String id, ServerGroupObject group, String state, String extra, String map, String motd, List<PlayerObject> onlinePlayers, int onlinePlayerCount, int maxPlayerCount, BaseObject base, InetSocketAddress socketAddress) {
