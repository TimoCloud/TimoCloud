...
public class LobbyManager {
    ...
    private LobbyChooseStrategy getLobbyChooseStrategy() {
        LobbyChooseStrategy lobbyChooseStrategy = LobbyChooseStrategy.valueOf(TimoCloud.getInstance().getFileManager().getConfig().getString("LobbyChooseStrategy"));
    ...
    private ServerInfo searchFreeLobby(UUID uuid, ServerInfo notThis) {
        Group group = TimoCloud.getInstance().getServerManager().getGroupByName(TimoCloud.getInstance().getFileManager().getConfig().getString("fallbackGroup"));
        ...
        Server notThisServer = notThis == null ? null : TimoCloud.getInstance().getServerManager().getServerByName(notThis.getName());
