...
public class GroupObjectBasicImplementation implements GroupObject {
     ...
     */
    public GroupObjectBasicImplementation() {}

    /**
     * Do not use this - this will be done by TimoCloud
     */
    public GroupObjectBasicImplementation(List<ServerObject> servers, String name, int startupAmount, int maxAmount, int ram, boolean isStatic, String base, List<String> sortOutStates) {
